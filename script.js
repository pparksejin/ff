document.addEventListener("DOMContentLoaded", function() {
    ...
    let descriptionBoxTimer = null;
    let mouseMoveTimer = null;
    let descriptionBoxDisplayed = false;

    document.addEventListener("mousemove", function(event) {
        createTrail(event.pageX, event.pageY);
        clearTimeout(mouseMoveTimer);
        mouseMoveTimer = setTimeout(function() {
            if (!descriptionBoxDisplayed) {
                openDescriptionBox();
            }
        }, 180000);
    });
        ...
        switch (articleId) {
            case "article1":
                return {
                    ...
                    image: "https://github.com/pparksejin/ff/blob/main/asset/tear.jpg"
                };
            case "article2":
                return {
            ...
            case "article11":
                return {
                    ...
                    image: "/asset/hongik.jpg"
                };
            case "article12":
                return {
                    content: "바로 너..?\n\n너는 널 볼 수 없겠지. 중요한 것은 보이지 않아!\n\n하지만 너만은 선명하게!",
                };
            default:
                return {
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function saveComment(comment) {
        ...
        commentItem.scrollIntoView({ behavior: "smooth", block: "end", inline: "nearest" });
       }
    });
